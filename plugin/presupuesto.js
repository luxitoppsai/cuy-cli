 ...
 *
 * El corte se hace en `tool.execute.before`: es el único punto donde se puede frenar
 * al agente antes de que siga gastando, porque lanzar ahí aborta la operación.
 */

const LIMITE = Number(process.env.CUY_LIMITE_TOKENS ?? 300000);
